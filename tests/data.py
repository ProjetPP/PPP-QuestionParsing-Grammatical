    ...
    return  {'coref': [[[['It', 0, 13, 13, 14], ['the Sky with Diamonds', 0, 6, 5, 9]]]],
             'sentences': [{'dependencies': [['root', 'ROOT', 'wrote'],
               ...
               'indexeddependencies': [['root', 'ROOT-0', 'wrote-2'],
                ...
                ['nsubj', 'Be-15', 'It-14'],
                ['ccomp', 'Let-13', 'Be-15']],
               'parsetree': "(ROOT (SBARQ (SBARQ (WHNP (WP Who)) (SQ (VP (VBD wrote) (`` ``) (NP (NP (NNP Lucy)) (PP (IN in) (NP (NP (DT the) (NN Sky)) (PP (IN with) (NP (NNPS Diamonds)))))) ('' '')))) (CC and) (S (VP (`` ``) (VB Let) (S (NP (PRP It)) (VP (VB Be) ('' ''))))) (. ?)))",
